...
Metropolis1D::Metropolis1D (double x)
{
    m_x = x ;
    m_alpha = 0. ;
    m_gen = NULL ;
...
Metropolis1D::Metropolis1D (double x, Random* gen, Basic_PDF * prob)
{
    m_x = x ;
    m_alpha = 0. ;
    m_gen = gen ;
...
double Metropolis1D::alpha () const
{
    return m_alpha ;
}

 void Metropolis1D::Set_x (double n)
{
    m_x = n ;
    return ;
}

void Metropolis1D::Set_PDF (Basic_PDF * prob)
{
    m_prob = prob ;
    return ;
}
...
void Metropolis1D::MRT2_Unif (double max)
{
    double xnew = m_x + m_gen->Rannyu(-max, max) ;
    m_alpha = fmin ( 1, m_prob->Probability(xnew, 0, 0) / m_prob->Probability(m_x, 0, 0) ) ;
...
void Metropolis1D::MRT2_Gauss (double sigma)
{
